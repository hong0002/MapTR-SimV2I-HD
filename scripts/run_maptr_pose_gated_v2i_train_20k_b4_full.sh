...
# Resume only from this pose-gated work_dir, for example:
#   GPUS=4 bash scripts/run_maptr_pose_gated_v2i_train_20k_b4_full.sh \
#     --resume-from outputs/maptr/pose_gated_v2i_r18_20k_b4/epoch_XX.pth
...
WORK_DIR="${MAPTR_TRAIN_WORK_DIR:-outputs/maptr/pose_gated_v2i_r18_20k_b4}"
