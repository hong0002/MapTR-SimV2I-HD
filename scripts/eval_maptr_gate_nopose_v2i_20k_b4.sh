...
CHECKPOINT="${1:?Usage: bash scripts/eval_maptr_gate_nopose_v2i_20k_b4.sh path/to/checkpoint.pth}"
WORK_DIR="${MAPTR_EVAL_WORK_DIR:-outputs/maptr/gate_nopose_v2i_r18_20k_b4}"
