...
CONFIG="integrations/maptr/configs/simv2i_maptr_v2_dynamic_rsu_top4_r18_20k_geo_b4.py"
CHECKPOINT="${1:?Usage: bash scripts/eval_dynamic_top4_geo.sh path/to/checkpoint.pth}"
WORK_DIR="${MAPTR_EVAL_WORK_DIR:-outputs/maptr_geo/v2_dynamic_rsu_top4_r18_20k_geo_b4}"
