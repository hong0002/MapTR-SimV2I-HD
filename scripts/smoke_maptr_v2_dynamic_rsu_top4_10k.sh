...
CONFIG="integrations/maptr/configs/simv2i_maptr_v2_dynamic_rsu_top4_r18_10k_smoke.py"
WORK_DIR="${MAPTR_TRAIN_WORK_DIR:-outputs/maptr/v2_dynamic_rsu_top4_r18_10k_smoke}"
