...
CONFIG="integrations/maptr/configs/simv2i_maptr_v2i_1rsu_r18_stronger_10k_smoke.py"
WORK_DIR="${MAPTR_TRAIN_WORK_DIR:-outputs/maptr/v2i_1rsu_r18_stronger_10k_smoke}"
