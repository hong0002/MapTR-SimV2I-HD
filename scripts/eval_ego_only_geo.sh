...
CONFIG="integrations/maptr/configs/simv2i_maptr_ego_only_r18_20k_geo_b4.py"
CHECKPOINT="${1:?Usage: bash scripts/eval_ego_only_geo.sh path/to/checkpoint.pth}"
WORK_DIR="${MAPTR_EVAL_WORK_DIR:-outputs/maptr_geo/ego_only_r18_20k_geo_b4}"
