...
CONFIG="integrations/maptr/configs/simv2i_maptr_v2_dynamic_rsu_top4_r18_20k_b16_smoke.py"
WORK_DIR="${MAPTR_TRAIN_WORK_DIR:-outputs/maptr/v2_dynamic_rsu_top4_r18_20k_b16_smoke}"
...
echo "Running dynamic-RSU top-4 20k batch16 config/dataloader precheck..."
...
cfg_path = (
    ...
    'simv2i_maptr_v2_dynamic_rsu_top4_r18_20k_b16_smoke.py'
)
out_path = Path(
    'outputs/maptr/v2_dynamic_rsu_top4_r18_20k_b16_smoke/'
...
assert cfg.data.samples_per_gpu == 4, cfg.data.samples_per_gpu
assert gpus == 4, gpus
assert total_batch == 16, total_batch
