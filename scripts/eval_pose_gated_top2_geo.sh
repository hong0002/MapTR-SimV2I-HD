...
CHECKPOINT="${1:?Usage: bash scripts/eval_pose_gated_top2_geo.sh path/to/checkpoint.pth}"
WORK_DIR="${MAPTR_EVAL_WORK_DIR:-outputs/maptr_geo/pose_gated_v2i_r18_20k_geo_top2_b4}"
