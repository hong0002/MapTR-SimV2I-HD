...
CONFIG="integrations/maptr/configs/simv2i_maptr_ego_only_r18_20k_b4_smoke.py"
WORK_DIR="${MAPTR_TRAIN_WORK_DIR:-outputs/maptr/ego_only_r18_20k_b4_smoke}"
...
echo "Running ego-only 20k batch4 config/dataloader precheck..."
...
cfg_path = 'integrations/maptr/configs/simv2i_maptr_ego_only_r18_20k_b4_smoke.py'
out_path = Path('outputs/maptr/ego_only_r18_20k_b4_smoke/dataloader_smoke.json')
...
assert gpus == 4, gpus
assert total_batch == 4, total_batch
...
result = {
    ...
    'ego_view_count': selected_groups.count('ego'),
