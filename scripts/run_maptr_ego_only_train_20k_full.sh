...
# Resume example:
#   GPUS=4 bash scripts/run_maptr_ego_only_train_20k_full.sh \
#     --resume-from outputs/maptr/ego_only_r18_20k/epoch_XX.pth

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
source "${SCRIPT_DIR}/_maptr_runtime.sh"
maptr_init

CONFIG="integrations/maptr/configs/simv2i_maptr_ego_only_r18_20k.py"
WORK_DIR="${MAPTR_TRAIN_WORK_DIR:-outputs/maptr/ego_only_r18_20k}"
