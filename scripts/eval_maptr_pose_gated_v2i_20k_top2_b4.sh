...
CHECKPOINT="${1:?Usage: bash scripts/eval_maptr_pose_gated_v2i_20k_top2_b4.sh path/to/checkpoint.pth}"
WORK_DIR="${MAPTR_EVAL_WORK_DIR:-outputs/maptr/pose_gated_v2i_r18_20k_top2_b4}"
