...
CHECKPOINT="${1:?Usage: bash scripts/eval_maptr_v2_dynamic_rsu_top4_20k_b16.sh path/to/checkpoint.pth}"
WORK_DIR="${MAPTR_EVAL_WORK_DIR:-outputs/maptr/v2_dynamic_rsu_top4_r18_20k_b16}"
