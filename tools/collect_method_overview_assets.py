...
def write_report(report_path, output_root, manifest, contact_sheets):
    ...
    lines = [
        ...
        "## Investigated Paths",
        "",
        "- `/data1/jihong/MapTR/data/raw`",
        "- `/data1/jihong/MapTR/data/maptr`",
        "- `/data1/jihong/MapTR/outputs`",
        "- `/data1/jihong/MapTR/outputs/maptr/visualizations`",
        "- `/data1/jihong/MapTR/outputs/maptr/visualizations/qualitative_ranking`",
        "- `/data1/jihong/MapTR/outputs/maptr/visualizations/bev_map_comparison`",
        "- `/data1/jihong/MapTR/tools`",
        "- `/data1/jihong/MapTR/scripts`",
        "- `/data1/jihong/ACCV_2026_template` (read-only check; only existing qualitative PDF was found in `figures/`)",
        "",
        "## Key Findings",
        "",
