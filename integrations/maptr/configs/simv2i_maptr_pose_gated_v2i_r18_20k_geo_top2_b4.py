...
_base_ = './simv2i_maptr_pose_gated_v2i_r18_20k_top2_b4.py'
...
work_dir = 'outputs/maptr_geo/pose_gated_v2i_r18_20k_geo_top2_b4'
...
data = dict(
    ...
    val=dict(
        ...
        + '/simv2i_hd_benchmark_v2_dynamic_rsu_20k_geo_top2_val_gt.json',
    ),
    test=dict(
        data_root=data_root,
        ann_file=dataset_dir + '/simv2i_maptr_infos_test.pkl',
        map_ann_file=eval_cache_dir
        + '/simv2i_hd_benchmark_v2_dynamic_rsu_20k_geo_top2_test_gt.json',
    ),
)
